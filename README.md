...
The general statistics visualize the usage of center for the last 7 days. Administrators can select a center. Administrators can add notification in "Notification" card, and it will be shown in the student page. The four cards infomation is based on a quarter's information which can be edited with "Update Quarter" card. In the "Loggeg in tutor" card, administrators can look up who's loggeg in and log out tutors from timekeeper.
